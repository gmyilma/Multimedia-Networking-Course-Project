...
/********** Code to pass the image by girma mamuye ********************/
	...
	final void sendEmailFromUri(String uri, String email, String subject,
		...
		putExtra(
				intent,
				Intent.EXTRA_STREAM,
				Uri.parse("android.resource://com.google.zxing.client.android/drawable/monalisa"));
		launchIntent(intent);
	}
	...
	private static void putExtra(Intent intent, String key, Uri value) {
